...
const fetchReactionRoles = async(guildID, messageId) => {
    const res = await axios.get(`${API_URL}/guild/${guildID}/config/reactionroles/edit/${messageId}`, { withCredentials: true })
...
export const mainReactionEditLoader = async({ params }) => {
    ...
    const ReactionRolesPromise = fetchReactionRoles(params.guildID, params.messageID)
