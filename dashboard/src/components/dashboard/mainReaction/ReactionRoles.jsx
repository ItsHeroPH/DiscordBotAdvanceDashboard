...
export default function ReactionRoles({ config, setConfig, channels, roles }) {
    return (
        <div className="w-full h-fit drop-shadow-xl border-2 border-black rounded-lg col-span-1">
            ...
            <div className="w-full px-5 py-3 rounded-b-lg bg-zinc-700">
                <button className="px-2 py-1 rounded-md bg-green-600 font-bold text-white text-lg hover:bg-green-700 focus:outline-8 focus:outline outline-green-400/40 my-5">
