    ...
    return(
        <>
            { isLoading ? (
                ...
                <div className="w-[250px] h-[200px] border-4 border-stone-900 rounded-2xl transition-all duration-300 hover:translate-y-[-10%] hover:drop-shadow-2xl cursor-pointer">
